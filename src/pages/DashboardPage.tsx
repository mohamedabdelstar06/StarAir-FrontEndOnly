...
export function DashboardPage() {
    ...
    return (
        <div className="p-4 lg:p-8 animate-slide-up max-w-7xl mx-auto space-y-6">
            <h1 className="text-2xl font-black text-black tracking-tight uppercase">Admin Dashboard</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="glass-card p-6 flex flex-col justify-center border-2 border-slate-200">
                    <div className="flex items-center gap-4 mb-2">
                        <div className="p-3 bg-primary-100 text-primary-600 rounded-xl"><Users size={24} /></div>
                        <div className="text-3xl font-black text-black">{loading ? '-' : stats?.totalPilots ?? 0}</div>
                    </div>
                ...
                <div className="glass-card p-6 flex flex-col justify-center border-2 border-slate-200">
                    <div className="flex items-center gap-4 mb-2">
                        ...
                        <div className="text-3xl font-black text-black">{loading ? '-' : stats?.activePilots ?? 0}</div>
                    </div>
                ...
                <div className="glass-card p-6 flex flex-col justify-center border-2 border-slate-200">
                    <div className="flex items-center gap-4 mb-2">
                        ...
                        <div className="text-3xl font-black text-black">{loading ? '-' : (stats?.totalImSafeAssessments ?? 0) + (stats?.totalPaveAssessments ?? 0)}</div>
                    </div>
                ...
                <div className="glass-card p-6 flex flex-col justify-center border-2 border-slate-200">
                    <div className="flex items-center gap-4 mb-2">
                        ...
                        <div className="text-3xl font-black text-black">{loading ? '-' : stats?.pendingPilots ?? 0}</div>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="glass-card p-5 border-2 border-green-200 bg-green-50/50 flex items-center gap-4">
                    <div className="w-12 h-12 rounded-xl bg-green-500 flex items-center justify-center text-white font-black text-lg">✓</div>
                    <div>
                        <div className="text-3xl font-black text-black">{loading ? '-' : stats?.goCount ?? 0}</div>
                ...
                <div className="glass-card p-5 border-2 border-amber-200 bg-amber-50/50 flex items-center gap-4">
                    <div className="w-12 h-12 rounded-xl bg-amber-500 flex items-center justify-center text-white font-black text-lg">⚠</div>
                    <div>
                        <div className="text-3xl font-black text-black">{loading ? '-' : stats?.cautionCount ?? 0}</div>
                ...
                <div className="glass-card p-5 border-2 border-red-200 bg-red-50/50 flex items-center gap-4">
                    <div className="w-12 h-12 rounded-xl bg-red-500 flex items-center justify-center text-white font-black text-lg">✕</div>
                    <div>
                        <div className="text-3xl font-black text-black">{loading ? '-' : stats?.noGoCount ?? 0}</div>
